...
impl FluteServer {
    pub fn new(config: Arc<Config>, runner: Arc<dyn CliRunner>) -> Self {
        ...
        let tool_router = Self::util_router() + Self::transactions_router() + Self::ach_router() + Self::customers_router() + Self::terminals_router() + Self::devices_router() + Self::pos_router();
