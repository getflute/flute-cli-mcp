...
impl FluteServer {
    ...
    #[tool(
        description = "Get a terminal's status by id. A terminal must be SemiIntegrated + Online to accept POS transactions. Safe to retry."
    )]
    pub async fn terminals_status(
        &self,
